    ...
    <section className="py-12 bg-gray-950">
      <div className="container flex flex-col mx-auto lg:flex-row">
        ...
        <div className="flex flex-col w-full p-6 lg:w-1/2 md:p-8 lg:p-12 self-center">
          <Text size="display">Stay tuned for updates</Text>
          <Text className="mt-4 mb-8">
            Feel free to reach out to us for any event-related questions.
          </Text>
          <button className="self-start px-10 py-3 text-lg font-medium bg-gray-100 text-gray-900">
            Contact Us
          </button>
        </div>
      </div>
